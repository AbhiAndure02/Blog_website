...
export default function About() {
  return (
    <div className="">
      <div className="flex flex-col gap-10 p-20 max-auto max-w-5xl px-4  mx-20">
      ...
      <p className="text-md max-auto mx-10 text-gray-500">At BlogHere, we're passionate about exploring the ever-evolving world of technology and its impact on our lives. From the latest gadgets to groundbreaking innovations, we're here to unravel the complexities of the digital age and make technology accessible to everyone. </p>
      <p className='text-gray-500 text-md mx-20'> 
      ...
      <p className='text-gray-500 text-md mx-20'>Our blog isn't just another tech news site; it's a hub—a hub for all things tech-related. From in-depth product reviews to expert analysis of industry trends, we cover a wide spectrum of topics to help you stay ahead in this fast-paced world.
      ...
      <div className=" p-3 bg-amber-100 dark:bg-slate-700  flex justify-center items-center mx-auto mb-5">
        <CallToAction />
      </div>
      </div>
    </div>
